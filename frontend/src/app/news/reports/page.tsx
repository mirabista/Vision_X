...
import { Newspaper, Download, ExternalLink, Loader2, FileText } from "lucide-react";
...
export default function NewsReportsPage() {
  ...
  const loadReports = async () => {
    try {
      const result = await apiClient.getNewsReports({ limit: 50 });
      if (result.success) {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-text">News Verification Reports</h1>
        ...
        {reports.length === 0 ? (
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <p className="text-muted mb-6">Complete a news verification to generate a report</p>
              <Link href="/news">
